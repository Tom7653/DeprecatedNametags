package com.github.acquized.nametags.utils;
...
public class Metrics {
    ...
    public enum Country {
         ...
         * @return The country from the giben locale or <code>null</code> if unknown country or if
         * the locale does not contain a country.
         */
